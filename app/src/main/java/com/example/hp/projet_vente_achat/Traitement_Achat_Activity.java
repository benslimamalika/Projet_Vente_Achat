...
/******************************************Remplier Hashmap ****************************************************************/
        ...
        map.put("titre", getString(R.string.map_voiture));
        map.put("desc", getString(R.string.map_voiture_symbol));
        map.put("img", String.valueOf(R.drawable.voiture2));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", getString(R.string.map_pc));
        map.put("desc", getString(R.string.map_desc_pc));
        map.put("img", String.valueOf(R.drawable.pc_hp4));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", getString(R.string.map_ram));
        map.put("desc", getString(R.string.map_desc_ram));
        map.put("img", String.valueOf(R.drawable.ram1));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", getString(R.string.map_clavier));
        map.put("desc", getString(R.string.map_desc_clavier));
...
/*************************************page déconnexion*******************************************************************/
        ...
        if (id == R.id.nav_deconnexion) {
            ...
            Toast.makeText(this, R.string.Menu_Vous_avez_deconnecter,Toast.LENGTH_LONG).show();
...
/**************************************activité vente ************************************************************************/
            ...
            startActivity(myIntent2);
            Toast.makeText(this, R.string.Menu_bienvenue_dans_la_page_vente,Toast.LENGTH_LONG).show();
