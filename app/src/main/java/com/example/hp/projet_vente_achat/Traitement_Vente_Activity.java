...
public class Traitement_Vente_Activity extends AppCompatActivity {
    ...
    public void Button_Enrg_produit(View view) {
        ...
        Toast.makeText(this,getString(R.string.mr_mdm) + Nom.getText().toString() + getString(R.string.votre_produit_est_enregistrer),Toast.LENGTH_LONG).show();
    ...
    public void Retour_v(View view) {
    ...
    public void deconnexion_v(View view) {
